    ...
    <div className={`space-y-6 relative transition-colors duration-500 min-h-full ${isEmergency ? 'siren-bg' : ''}`}>
      ...
      <div className="flex flex-col space-y-4">
        ...
        {currentPlayer && (
          ...
          >
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-rose-500">Sua Identidade</p>
      ...
      {isRevealing && selectedPlayer && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-6 bg-stone-950/98 backdrop-blur-3xl animate-in fade-in duration-300">
          <div className={`w-full max-w-sm rounded-[3rem] p-10 text-center space-y-10 border shadow-2xl relative ${
            selectedPlayer.role === Role.IMPOSTOR ? 'impostor-gradient pulse-red border-rose-500/50' : 
